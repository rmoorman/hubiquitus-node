...
var Controller = function(params){
    ...
    this.db.on('connect', function(){
        ...
        self.context.jid = params.jid;

        self.context.sendIQ = function(attrs, content, cb){
        ...
        //Tell everyone that we can receive commands
        self.emit('ready');
    });
    ...
    this.db.connect(params['mongo.URI']);
};
...
Controller.prototype.launchCommand = function(hCommand, resultListener, arguments){
    ...
    if(hCommand.transient === false){
        ...
        var commandInstance = new this.context.models.hCommand();
    ...
    function saveHResult(hResult, reqID){
        var hResultInstance = new self.context.models.hResult();
