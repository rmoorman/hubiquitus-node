...
var Controller = function(params){
    ...
    this.context.sendIQ = function(attrs, content, cb){
...
Controller.prototype.addListeners = function(){
    ...
    this.component.on('stanza', function(stanza){
        if(stanza.is('iq') && stanza.attrs.id !== 'undefined' &&
            self.iqListeners[stanza.attrs.id] !== 'undefined'){

            var cb = self.iqListeners[stanza.attrs.id];
            delete self.iqListeners[stanza.attrs.id];
            cb(stanza);
        }
    });
