...
hSubscribe.prototype.exec = function(hCommand, context){
    ...
    context.models.hChannel.findOne({chid: channel}, function(err, doc){
        if(!err){
            if(doc){
...
hSubscribe.prototype.subscribePublisher = function(chid, jid, context, hCommand){
    var self = this;
    context.models.user.findOne({jid: jid}, function(err, doc){
        ...
        //All good to go
        var instance = doc || new context.models.user();
