...
hEcho.prototype.exec = function(hMessage, context, cb){
    ...
    /* EBR : ajouter un test genre si params === 'DIV0' alors faire une division par 0 pour provoquer une erreur tehcnique
        ainsi on pourra tester le bon comportement du hNode pour la gestion des erreurs techniques graves */
