...
hCreateUpdateChannel.prototype.exec = function(hMessage, context, cb){
    ...
    //This test is applied not to break other tests that include if actor exists, etc.
    ...
    // EBR, je ne comprends pas pourquoi on ne fait pas appel au validator sur la structure d'un hChannel ?
    // bon nombre de tests fait ici me semblent redondants...
