...
hPublish.prototype.exec = function(hCommand, context, cb){
    ...
    if(channel.location)
        instance.location = JSON.parse(JSON.stringify(channel.location)); //Deep copy
    ...
    if(hMessage['transient'] === false){
        ...
        //TODO: Why not publish the message and save async for performance
        instance.save(function(errSave){
            if(!errSave){
                ...
                instance._id = undefined; //Do not send internal mongo value
