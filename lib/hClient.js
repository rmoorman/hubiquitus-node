...
var hClient = function( cmdControllerOpts ){
    ...
    //Set the filter and the filtersOrder to the cmd controller
    this.cmdController.context.filters = this.filters;
    this.cmdController.context.filtersOrder = this.filtersOrder;
};
